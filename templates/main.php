<div id="app-content">
	...
	Notice: Currently, Batch is beta testing. Use at your own risk - jobs may be deleted, terminated or restarted.
	...
	<h2 class="running_jobs"><?php p($l->t("Running jobs")); ?>
	<a id="jobs_refresh" class="btn btn-default" title="<?php p($l->t("Refresh")); ?>">&#8634;</a></h2>
	<div id="running_jobs">
